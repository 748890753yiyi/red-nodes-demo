module.exports = function(RED) {
    ...
    RED.nodes.registerType('LIGHT in',lightInput);
        ...
        node.on("input",function(msg){
            var clientOutput = net.connect(port, host, function() {
                ...
                if(msg.payload){
                    ...
                    clientOutput.write(JSON.stringify(config));
                }
    ...
    RED.nodes.registerType('LIGHT out',lightOutput);
}